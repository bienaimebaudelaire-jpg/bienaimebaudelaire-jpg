...
def auto_learning_worker():
    ...
    while True:
        try:
            ...
            # Attendre 10 secondes entre les cycles pour les tests
            time.sleep(10)
...
def generate_real_p3_innovation(query: str, context: dict):
    ...
    if any(word in query_lower for word in ['arbitrage', 'conflit', 'ppbe', 'governance']):
        return {
            ...
            "snippet": """ARCHITECTURE HUMEAN v2.0 - COUCHE D'ARBITRAGE (NIVEAU 5)

PROBLÈME RÉSOLU : Conflits PPBE vs Governance

SOLUTION INNOVANTE :
1. Mécanisme d'arbitrage contextuel
2. Arbre de décision à 3 niveaux  
3. Score_Conflict = |Energy_Need - Ethics_Weight|
4. Protocole d'escalade adaptatif
